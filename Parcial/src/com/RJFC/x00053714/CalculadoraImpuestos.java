...
public final class CalculadoraImpuestos {
    ...
    public static double calcularPago(Empleado UnEmpleado) {
        ...
        int ConsultarOAgregar = Integer.parseInt(JOptionPane.showInputDialog(null, "¿Que desea?\n1. Solamente consultar salario liquido" +
    ...
    public static String mostrarTotales () {
        String totales = "Descuentos acumulados de empleados a los que se les ha calculado salario liquido\nTotal ISSS: $" + totalISSS + "\n"
